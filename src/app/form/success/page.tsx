    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center w-full lg:w-[900px] mt-[32px] mx-auto overflow-hidden px-2">
        ...
        <p className="text-white font-medium  text-[18] lg:text-[24px] text-center mt-[16px]">
          Entraremos em contato com você lhe enviando o grupo exclusivo para pilotos e informando o seu número, pedimos que aguarde o contato.
        </p>
        <p className="text-white font-medium  text-[18] lg:text-[24px] text-center mt-[16px]">
          E aguardamos sua presença no evento! e qualquer dúvida entre em contato
          no nosso whatsapp.
        </p>
